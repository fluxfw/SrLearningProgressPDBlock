...
```php
//...
use srag\RemovePluginDataConfirm\SrLearningProgressPDBlock\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrLearningProgressPDBlock\x\RepositoryObjectPluginUninstallTrait;
//...
