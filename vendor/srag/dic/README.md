...
```php
\srag\DIC\SrLearningProgressPDBlock\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrLearningProgressPDBlock\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrLearningProgressPDBlock\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
