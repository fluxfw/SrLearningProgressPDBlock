...
```php
...
use srag\GeneratePluginInfosHelper\SrLearningProgressPDBlock\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrLearningProgressPDBlock\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrLearningProgressPDBlock\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrLearningProgressPDBlock\x\UpdateVersion; 
...
