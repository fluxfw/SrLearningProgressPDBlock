...
```php
...
use srag\ActiveRecordConfig\SrLearningProgressPDBlock\x\Utils\ConfigTrait;
...
class x {
...
use ConfigTrait;
...
<#x>
<?php
\srag\ActiveRecordConfig\SrLearningProgressPDBlock\x\Repository::getInstance()->installTables();
?>
```
