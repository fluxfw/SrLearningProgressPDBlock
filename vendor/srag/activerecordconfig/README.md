...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrLearningProgressPDBlock\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\SrLearningProgressPDBlock\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\SrLearningProgressPDBlock\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
