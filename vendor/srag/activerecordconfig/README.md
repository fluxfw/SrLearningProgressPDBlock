...
```php
...
use srag\ActiveRecordConfig\SrLearningProgressPDBlock\x\Config\AbstractFactory;
use srag\ActiveRecordConfig\SrLearningProgressPDBlock\x\Config\AbstractRepository;
...
